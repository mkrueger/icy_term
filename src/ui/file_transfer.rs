...
/* 
        ...
        table.body(|mut body| {
            body.row(row_height, |mut row| {
                row.col(|ui| {
                    ...
                    ui.label(RichText::new(state.protocol_name.clone()).font(text_style.clone()).color(Color32::WHITE));
                });

                row.col(|ui| {
                    ui.label(RichText::new("Total errors:").font(text_style.clone()));
                    ui.label(RichText::new(transfer_info.errors.to_string()).font(text_style.clone()).color(Color32::WHITE));
                });
            });
            ...
            body.row(row_height, |mut row| {
                row.col(|ui| {
                    ...
                    ui.label(RichText::new(check).font(text_style.clone()).color(Color32::WHITE));
                });

                row.col(|ui| {
                    ui.label(RichText::new("Elapsed time:").font(text_style.clone()));
                    ui.label(RichText::new(elapsed_time).font(text_style.clone()).color(Color32::WHITE));
                });
            });
            ...
            body.row(row_height, |mut row| {
                row.col(|ui| {
                    ...
                    ui.label(RichText::new(current_state).font(text_style.clone()).color(Color32::WHITE));
                });
                ...
                row.col(|ui| {
                    ...
                    ui.label(RichText::new(format!(
                        ...
                        time_left.as_secs() % 60
                    )).font(text_style.clone()).color(Color32::WHITE));
                });
            });
        });
        ...
        ui.horizontal(|ui| {
            ...
            ui.label(RichText::new(file_name).font(text_style.clone()).color(Color32::WHITE));
        });
        ui.add(ProgressBar::new(transfer_info.bytes_transfered as f32 / transfer_info.file_size as f32).text(
            RichText::new(format!(
                "{}% {}/{}",
                (transfer_info.bytes_transfered * 100) / max(1, transfer_info.file_size),
                bb.bytes(transfer_info.bytes_transfered as u64),
                bb.bytes(transfer_info.file_size as u64))).font(text_style.clone())
        ));
        ui.horizontal(|ui| {
            ui.label(RichText::new("transfer rate:").font(text_style.clone()));
            ui.label(RichText::new(format!("{} per second", bb.bytes(bps as u64))).font(text_style.clone()).color(Color32::WHITE));
        });
    });
    open
}
