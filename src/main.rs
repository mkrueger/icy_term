...
pub fn main() -> iced::Result {
    println!("{:X}", crc16::get_crc32(b"foo\n\x68"));

    Zmodem::encode_subpacket_crc32(ZCRCE, b"foo\n");

  /* for b in Zmodem::build_bin_header_crc32(frame_types::ZFILE, 0, 0, ZFILE_FLAG::ZMNEW, ZFILE_FLAG::ZCRESUM) {
        print!("{:X},", b);
    }
    println!(); */
