...
pub const C64_DEFAULT_PALETTE: [Color; 16] = [
    Color { r: 0x00, g: 0x00, b: 0x00 }, // black
    Color { r: 0xFF, g: 0xFF, b: 0xFF }, // white
    Color { r: 0x88, g: 0x00, b: 0x00 }, // red
    Color { r: 0xAA, g: 0xFF, b: 0xEE }, // cyan
    Color { r: 0xCC, g: 0x44, b: 0xCC }, // violett
    Color { r: 0x00, g: 0xCC, b: 0x55 }, // green
    Color { r: 0x00, g: 0x00, b: 0xAA }, // blue
    Color { r: 0xEE, g: 0xEE, b: 0x77 }, // yellow
    Color { r: 0xDD, g: 0x88, b: 0x55 }, // orange
    Color { r: 0x66, g: 0x44, b: 0x00 }, // brown
    Color { r: 0xFF, g: 0x77, b: 0x77 }, // lightred
    Color { r: 0x33, g: 0x33, b: 0x33 }, // gray1
    Color { r: 0x77, g: 0x77, b: 0x77 }, // gray2
    Color { r: 0xAA, g: 0xFF, b: 0x66 }, // lightgreen
    Color { r: 0x00, g: 0x88, b: 0xFF }, // lightblue
    Color { r: 0xBB, g: 0xBB, b: 0xBB }, // gray3
];
